...
| 5 | sort_column | Không bắt buộc, phải thuộc: approval_group_id, group_name_ja, status, created_at | CMS-VAL-41 | 選択されたソートカラムは正しくありません。 |
| 6 | sort_direction | Không bắt buộc, phải là asc hoặc desc | CMS-VAL-41 | 選択されたソート方向は正しくありません。 |
