...
| --- | --- | --- | --- | --- |
| 1 | id (path) | Bắt buộc, tồn tại trong mst_saki_user | CMS-VAL-23 | id (path)を入力してください。 |
| 2 | last_name_ja | Bắt buộc nhập | CMS-VAL-23 | 姓（和文）を入力してください。 |
| 3 | last_name_ja | Tối đa 24 ký tự | CMS-VAL-6 | 姓（和文）は24文字以内で入力してください。 |
| 4 | first_name_ja | Bắt buộc nhập | CMS-VAL-23 | 名（和文）を入力してください。 |
| 5 | first_name_ja | Tối đa 24 ký tự | CMS-VAL-6 | 名（和文）は24文字以内で入力してください。 |
| 6 | last_name_kana | Bắt buộc nhập | CMS-VAL-23 | 姓（カナ）を入力してください。 |
| 7 | last_name_kana | Phải là Katakana toàn giác | CMS-VAL-41 | 選択された姓（カナ）は正しくありません。 |
| 8 | first_name_kana | Bắt buộc nhập | CMS-VAL-23 | 名（カナ）を入力してください。 |
| 9 | first_name_kana | Phải là Katakana toàn giác | CMS-VAL-41 | 選択された名（カナ）は正しくありません。 |
| 10 | office_id | Bắt buộc nhập, phải tồn tại trong mst_saki_office | CMS-VAL-23 | 事業所IDを入力してください。 |
| 11 | department_id | Bắt buộc nhập, phải tồn tại trong mst_saki_department | CMS-VAL-23 | 部門IDを入力してください。 |
| 12 | email | Bắt buộc nhập, đúng định dạng email | CMS-VAL-23 | メールアドレスを入力してください。 |
| 13 | tel | Bắt buộc nhập, tối đa 15 ký tự half-width | CMS-VAL-23 | 電話番号を入力してください。 |
| 14 | reference_scope | Bắt buộc nhập, giá trị từ 1 đến 6 | CMS-VAL-23 | 参照範囲を入力してください。 |
| 15 | user_scopes | Bắt buộc nhập khi reference_scope = 6 | CMS-VAL-23 | user_scopesを入力してください。 |
| 16 | user_scopes[].target_id | Tồn tại trong office_id hoặc department_id | SCOPE_TARGET_NOT_FOUND | Đối tượng tham chiếu chỉ định không tồn tại. |
| 17 | cost_center_code | Không chứa ký tự Katakana half-width | CC_INVALID | Mã cost center không hợp lệ. |
